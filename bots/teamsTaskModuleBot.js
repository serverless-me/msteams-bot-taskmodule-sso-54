...
const Actions = [
    ...
    TaskModuleUIConstants.GraphPage,
...
class TeamsTaskModuleBot extends TeamsActivityHandler {
    ...
    handleTeamsTaskModuleFetch(context, taskModuleRequest) {
        ...
        } else if (cardTaskFetchValue === TaskModuleIds.GraphPage) {
            // Display the CustomForm.html page, and post the form data back via
            // handleTeamsTaskModuleSubmit.
            taskInfo.url = taskInfo.fallbackUrl = this.baseUrl + '/' + TaskModuleIds.GraphPage + '.html';
            this.setTaskInfo(taskInfo, TaskModuleUIConstants.GraphPage);
